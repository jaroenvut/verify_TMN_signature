...
-----END PUBLIC KEY-----`;
    ...
    if (timestamp && signature) {
        ...
        if (result) {
            ...
            respBody = {"status":{"code":"00000","message":"Success","description":"Verify TMN signature success"},"data":{"notify_id":(notifyId)}}
        } else {
    ...
    const data_signature = (ResponseTimestamp)+(respBody);
