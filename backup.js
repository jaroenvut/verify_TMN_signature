...
app.post('/', (req, res) => {
    ...
    if (Buffer.isBuffer(req.body)) {
        console.log('Buffer content:', req.body.toString());
    } else if (typeof req.body === 'object') {
        console.log('Object content:', JSON.stringify(req.body, null));
    } else {
        console.log('String content:', req.body);
    }
//});
...
-----END PUBLIC KEY-----`;
        ...
        console.log("Payload : " + inputJSON);
        //console.log('Formatted:', JSON.stringify(req.body, null, 2));
        console.log('Formatted:', JSON.stringify(req.body, null));
